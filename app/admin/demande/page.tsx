  ...
  return (
    <div className="min-h-screen p-5 space-y-4">
      <div className="grid grid-cols-4 gap-2 ">
        {statItems.map((item) => (
          <Card key={item.titre} className="shadow-none rounded-sm hover:scale-y-105 hover:shadow-sm transition-all duration-300 hover:bg-sky-50 dark:hover:bg-slate-700">
            <CardHeader>
      ...
      <Card className="border h-2/3 max-h-72 rounded">
        ...
        <CardContent className="flex flex-col gap-2 overflow-auto  rounded-sm">
          {billetItem.map((item) => (
            <div
              key={item.nom}
              className="group border border-dashed flex  justify-between  px-4 py-3 rounded-sm hover:bg-slate-50 dark:hover:bg-zinc-700 dark:hover:scale-y-105 transition-all duration-300 cursor-default"
